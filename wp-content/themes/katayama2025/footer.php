    ...
    <div class="container mx-auto px-4">
        ...
        <div class="hidden md:grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div class="footer-column">
                <h3 class="text-xl font-bold mb-6 border-b-2 border-katayama-orange pb-2">
                    会社情報
                </h3>
                <?php
                wp_nav_menu([
            ...
            <div class="footer-column">
                ...
                <div class="mt-8 space-y-4">
                    <a href="tel:0120-XXX-XXX" class="flex items-center gap-2 hover:text-katayama-orange transition-colors">
                    ...
                    <a href="mailto:info@example.com" class="flex items-center gap-2 hover:text-katayama-orange transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
...
<!-- ページトップボタン -->
<button id="page-top" class="fixed bottom-8 right-8 w-12 h-12 bg-katayama-orange rounded-full shadow-lg hover:shadow-xl transition-all opacity-0 invisible" aria-label="ページトップへ戻る">
